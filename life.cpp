...
Life Life::random(const std::size_t w = 100, const std::size_t h = 100) {
  std::random_device r;
...
void Life::set(const std::size_t idx) { m_board[idx] = true; }
void Life::clear(const std::size_t idx) { m_board[idx] = false; }
